...
def register():
    if request.method == 'POST':
        ...
        if not all([username, password, confirm_password, full_name, security_question, security_answer]):
        ...
        if password != confirm_password:
            ...
            return render_template('register.html')
        success, message = register_user(username, password, full_name, security_question, security_answer)
        if success:
...
def forgot_password():
    if request.method == 'POST':
        ...
        ok, msg = reset_password(username, security_question, security_answer, new_password)
